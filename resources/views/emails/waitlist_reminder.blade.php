...
<body>
    <div class="container">
        ...
        <a href="{{ $url }}" target="_blank" style="display: inline-block; margin-top: 20px; padding: 10px 15px; background-color: #1976D2; color: #ffffff; text-decoration: none; border-radius: 4px; text-align: center;">Update Information or Opt Out</a>
