...
export default function IndexPage() {
    ...
    const [waitlistForm, setWaitlistForm] = useState({
        ...
        phone: '',
        comment: '',
        location: '', // Added missing state
        hearAboutUs: '', // Added missing state
    });
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Typography
                    variant="body1"
                    sx={{ color: '#555', lineHeight: 1.6, marginBottom: 2 }}
                >
                    Our programs are currently operating with extended waitlists. Please note that the estimated wait time is a minimum of one year and may vary depending on your child’s age group and the location you’re interested in.
                </Typography>
                <Typography
                    variant="body1"
                    sx={{ color: '#555', lineHeight: 1.6 }}
                >
                    To add your child to the waitlist, click the <strong>Waitlist</strong> button below. For questions or comments, click <strong>Inquiry</strong>.
                </Typography>
            </Box>
            ...
            {showWaitlistForm && (
                ...
                >
                    ...
                    <TextField
                        ...
                        onChange={(e) => setWaitlistForm({ ...waitlistForm, hearAboutUs: e.target.value })}
                    />
                    <TextField
                        fullWidth
                        label="Comment"
